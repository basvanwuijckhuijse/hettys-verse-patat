...
const Menu = () => {
  ...
  const CATEGORIES: Cat[] = [
    ...
    },
    {
      ...
      items: language === "NL" ? [
        { name: "Bamihap", desc: "Kruidige bami", price: "€ 2,80", tag: "Vega" },
        ...
        { name: "Frikandel grof", desc: "Grove frikandel", price: "€ 2,90" },
        { name: "Goulash kroket", desc: "Kroket met goulashvulling", price: "€ 2,90" },
        { name: "Groente kroket*", desc: "Vol met groenten", price: "€ 2,90", tag: "Vega" },
        { name: "Halve kip", desc: "Malse halve kip", price: "€ 7,75" },
        { name: "Hamburger", desc: "Sappige hamburger", price: "€ 3,30" },
        { name: "Ham/kaassoufflé", desc: "Soufflé met ham en kaas", price: "€ 2,70" },
        ...
        { name: "Kipnuggets 6 st.", desc: "Krokante kipnuggets", price: "€ 3,70" },
        { name: "Knakworst", desc: "Klassieke knakworst", price: "€ 3,00" },
        { name: "Kroket*", desc: "Rundvleeskroket", price: "€ 2,30", tags: ["Vlees", "Vega"] },
        { name: "Kwekkeboom", desc: "Ambachtelijke kroket", price: "€ 3,00" },
        { name: "Loempia", desc: "Knapperige loempia", price: "€ 5,50" },
        { name: "Loempia speciaal", desc: "Loempia met plakje ham, gebakken ei en pindasaus", price: "€ 7,50" },
        { name: "Mexicano", desc: "Licht pittig", price: "€ 3,25" },
        { name: "Minisnacks 8 st.", desc: "Acht gemixte minisnacks", price: "€ 4,40" },
        { name: "Nasihap", desc: "Kruidige nasi", price: "€ 2,80" },
        { name: "Picanto", desc: "Pittige snack", price: "€ 3,25", tag: "Pittig" },
        { name: "Saté", desc: "Met onze huisgemaakte satésaus", price: "€ 7,50" },
        { name: "Satékroket", desc: "Kroket met satévulling", price: "€ 2,90" },
        { name: "Shoarmarol", desc: "Krokante rol met shoarma", price: "€ 3,50" },
        { name: "Smulrol", desc: "Hartige snackrol", price: "€ 3,50" },
        { name: "Sitostick", desc: "Pittige snackrol", price: "€ 3,70", tag: "Pittig" },
        { name: "Schnitzel", desc: "Gepaneerde schnitzel", price: "€ 7,50" },
        { name: "Slaatje", desc: "Huzarensalade met sla, komkommer en tomaat", price: "€ 3,50" },
        { name: "Trio", desc: "Hartige snack", price: "€ 3,50" },
        { name: "Viandel", desc: "Stevige frikandelsnack", price: "€ 2,90" },
        { name: "Vlammetjes 6 st.", desc: "Lekker pittig", price: "€ 4,25", tag: "Pittig" },
        { name: "Willempie", desc: "Kleine snack", price: "€ 3,00" },
      ] : language === "EN" ? [
        { name: "Bamihap", desc: "Spiced noodles", price: "€ 2.80", tag: "Veggie" },
        ...
        { name: "Coarse frikandel", desc: "Coarsely ground frikandel", price: "€ 2.90" },
        { name: "Goulash croquette", desc: "Croquette with goulash filling", price: "€ 2.90" },
        { name: "Vegetable croquette*", desc: "Full of vegetables", price: "€ 2.90", tag: "Veggie" },
        { name: "Half chicken", desc: "Tender half chicken", price: "€ 7.75" },
        { name: "Hamburger", desc: "Juicy hamburger", price: "€ 3.30" },
        { name: "Ham/cheese soufflé", desc: "Soufflé with ham and cheese", price: "€ 2.70" },
        ...
        { name: "Chicken nuggets 6 pcs.", desc: "Crispy chicken nuggets", price: "€ 3.70" },
        { name: "Frankfurter", desc: "Classic frankfurter", price: "€ 3.00" },
        { name: "Croquette*", desc: "Beef croquette", price: "€ 2.30", tags: ["Meat", "Veggie"] },
        { name: "Kwekkeboom croquette", desc: "Artisan croquette", price: "€ 3.00" },
        { name: "Spring roll", desc: "Crispy spring roll", price: "€ 5.50" },
        { name: "Spring roll special", desc: "Spring roll with a slice of ham, fried egg and peanut sauce", price: "€ 7.50" },
        { name: "Mexicano", desc: "Lightly spicy", price: "€ 3.25" },
        { name: "Mini snacks 8 pcs.", desc: "Eight mixed mini snacks", price: "€ 4.40" },
        { name: "Nasihap", desc: "Spiced fried rice fritter", price: "€ 2.80" },
        { name: "Picanto", desc: "Spicy snack", price: "€ 3.25", tag: "Spicy" },
        { name: "Satay", desc: "With our homemade satay sauce", price: "€ 7.50" },
        { name: "Satay croquette", desc: "Croquette with satay filling", price: "€ 2.90" },
        { name: "Shawarma roll", desc: "Crispy roll with shawarma", price: "€ 3.50" },
        { name: "Smulrol", desc: "Savoury snack roll", price: "€ 3.50" },
        { name: "Sitostick", desc: "Spicy snack roll", price: "€ 3.70", tag: "Spicy" },
        { name: "Schnitzel", desc: "Breaded schnitzel", price: "€ 7.50" },
        { name: "Small salad", desc: "Russian salad with lettuce, cucumber and tomato", price: "€ 3.50" },
        { name: "Trio", desc: "Savoury snack", price: "€ 3.50" },
        { name: "Viandel", desc: "Hearty frikandel-style snack", price: "€ 2.90" },
        { name: "Vlammetjes 6 pcs.", desc: "Nice and spicy", price: "€ 4.25", tag: "Spicy" },
        { name: "Willempie", desc: "Small snack", price: "€ 3.00" },
      ] : [
        { name: "Bamihap", desc: "Würzige Nudeln", price: "€ 2,80", tag: "Veggie" },
        ...
        { name: "Grobe Frikandelle", desc: "Grob gemahlene Frikandelle", price: "€ 2,90" },
        { name: "Gulaschkrokette", desc: "Krokette mit Gulaschfüllung", price: "€ 2,90" },
        { name: "Gemüsekrokette*", desc: "Voll mit Gemüse", price: "€ 2,90", tag: "Veggie" },
        { name: "Halbes Hähnchen", desc: "Zartes halbes Hähnchen", price: "€ 7,75" },
        { name: "Hamburger", desc: "Saftiger Hamburger", price: "€ 3,30" },
        { name: "Schinken-/Käsesoufflé", desc: "Soufflé mit Schinken und Käse", price: "€ 2,70" },
        ...
        { name: "Chicken Nuggets 6 Stk.", desc: "Knusprige Hähnchen-Nuggets", price: "€ 3,70" },
        { name: "Knackwurst", desc: "Klassische Knackwurst", price: "€ 3,00" },
        { name: "Krokette*", desc: "Rindfleischkrokette", price: "€ 2,30", tags: ["Fleisch", "Veggie"] },
        { name: "Kwekkeboom-Krokette", desc: "Handwerkliche Krokette", price: "€ 3,00" },
        { name: "Frühlingsrolle", desc: "Knusprige Frühlingsrolle", price: "€ 5,50" },
        { name: "Frühlingsrolle spezial", desc: "Frühlingsrolle mit einer Scheibe Schinken, Spiegelei und Erdnusssoße", price: "€ 7,50" },
        { name: "Mexicano", desc: "Leicht scharf", price: "€ 3,25" },
        { name: "Mini-Snacks 8 Stk.", desc: "Acht gemischte Mini-Snacks", price: "€ 4,40" },
        { name: "Nasihap", desc: "Würziger Nasi-Happen", price: "€ 2,80" },
        { name: "Picanto", desc: "Scharfer Snack", price: "€ 3,25", tag: "Scharf" },
        { name: "Saté", desc: "Mit unserer hausgemachten Satay-Soße", price: "€ 7,50" },
        { name: "Satay-Krokette", desc: "Krokette mit Satay-Füllung", price: "€ 2,90" },
        { name: "Schawarma-Rolle", desc: "Knusprige Rolle mit Schawarma", price: "€ 3,50" },
        { name: "Smulrol", desc: "Herzhafte Snackrolle", price: "€ 3,50" },
        { name: "Sitostick", desc: "Scharfe Snackrolle", price: "€ 3,70", tag: "Scharf" },
        { name: "Schnitzel", desc: "Paniertes Schnitzel", price: "€ 7,50" },
        { name: "Kleiner Salat", desc: "Kartoffelsalat mit Salat, Gurke und Tomate", price: "€ 3,50" },
        { name: "Trio", desc: "Herzhafter Snack", price: "€ 3,50" },
        { name: "Viandel", desc: "Herzhafter Frikandel-Snack", price: "€ 2,90" },
        { name: "Vlammetjes 6 Stk.", desc: "Schön scharf", price: "€ 4,25", tag: "Scharf" },
        { name: "Willempie", desc: "Kleiner Snack", price: "€ 3,00" },
      ],
    },
    {
      id: "hamburgers",
      ...
      items: language === "NL" ? [
        ...
        { name: "Spicy Vega", desc: "Pittige vegaburger", price: "€ 8,00", tag: "Vega" },
      ] : language === "EN" ? [
        ...
        { name: "Spicy Vega", desc: "Spicy veggie burger", price: "€ 8.00", tag: "Veggie" },
      ] : [
        ...
        { name: "Spicy Vega", desc: "Scharfer Veggie-Burger", price: "€ 8,00", tag: "Veggie" },
      ],
    },
    {
      id: "schotels",
      ...
      items: language === "NL" ? [
        { name: "Shoarma", desc: "Grote portie shoarma met losse pita", price: "€ 15,00" },
        { name: "Schnitzel", desc: "Gepaneerde schnitzel", price: "€ 15,00" },
        { name: "Hamburger", desc: "Sappige hamburger", price: "€ 11,50" },
        { name: "Hamburger speciaal", desc: "Met gebakken ui en currysaus", price: "€ 13,50" },
        { name: "Cheeseburger", desc: "Met uien, currysaus en gesmolten kaas", price: "€ 14,00" },
        { name: "Kipburger*", desc: "Krokante kipburger", price: "€ 14,00" },
        { name: "Halve kip", desc: "Malse halve kip", price: "€ 15,00" },
        { name: "Saté", desc: "Met onze huisgemaakte satésaus", price: "€ 15,00" },
        { name: "Loempia speciaal", desc: "Loempia met plakje ham, gebakken ei en pindasaus", price: "€ 14,50" },
        { name: "Spareribs", desc: "Onze beroemde spareribs", price: "€ 22,50", tag: "Special" },
        { name: "Smokey Mountain", desc: "Met rokerige BBQ-smaak", price: "€ 15,00" },
        { name: "Crunchy Chicken", desc: "Extra krokante kip", price: "€ 15,00" },
        { name: "Spicy Vega", desc: "Pittige vegaburger", price: "€ 15,00", tag: "Vega" },
      ] : language === "EN" ? [
        { name: "Shawarma", desc: "Large portion of shawarma with a separate pita", price: "€ 15.00" },
        { name: "Schnitzel", desc: "Breaded schnitzel", price: "€ 15.00" },
        { name: "Hamburger", desc: "Juicy hamburger", price: "€ 11.50" },
        { name: "Hamburger special", desc: "With fried onion and curry sauce", price: "€ 13.50" },
        { name: "Cheeseburger", desc: "With onion, curry sauce and melted cheese", price: "€ 14.00" },
        { name: "Chicken burger*", desc: "Crispy chicken burger", price: "€ 14.00" },
        { name: "Half chicken", desc: "Tender half chicken", price: "€ 15.00" },
        { name: "Satay", desc: "With our homemade satay sauce", price: "€ 15.00" },
        { name: "Spring roll special", desc: "Spring roll with a slice of ham, fried egg and peanut sauce", price: "€ 14.50" },
        { name: "Spareribs", desc: "Our famous spareribs", price: "€ 22.50", tag: "Special" },
        { name: "Smokey Mountain", desc: "With smoky BBQ flavour", price: "€ 15.00" },
        { name: "Crunchy Chicken", desc: "Extra crispy chicken", price: "€ 15.00" },
        { name: "Spicy Vega", desc: "Spicy veggie burger", price: "€ 15.00", tag: "Veggie" },
      ] : [
        { name: "Schawarma", desc: "Große Portion Schawarma mit separatem Pita", price: "€ 15,00" },
        { name: "Schnitzel", desc: "Paniertes Schnitzel", price: "€ 15,00" },
        { name: "Hamburger", desc: "Saftiger Hamburger", price: "€ 11,50" },
        { name: "Hamburger spezial", desc: "Mit gebratenen Zwiebeln und Currysoße", price: "€ 13,50" },
        { name: "Cheeseburger", desc: "Mit Zwiebeln, Currysoße und geschmolzenem Käse", price: "€ 14,00" },
        { name: "Hähnchenburger*", desc: "Knuspriger Hähnchenburger", price: "€ 14,00" },
        { name: "Halbes Hähnchen", desc: "Zartes halbes Hähnchen", price: "€ 15,00" },
        { name: "Saté", desc: "Mit unserer hausgemachten Satay-Soße", price: "€ 15,00" },
        { name: "Frühlingsrolle spezial", desc: "Frühlingsrolle mit einer Scheibe Schinken, Spiegelei und Erdnusssoße", price: "€ 14,50" },
        { name: "Spareribs", desc: "Unsere berühmten Spareribs", price: "€ 22,50", tag: "Spezial" },
        { name: "Smokey Mountain", desc: "Mit rauchigem BBQ-Geschmack", price: "€ 15,00" },
        { name: "Crunchy Chicken", desc: "Extra knuspriges Hähnchen", price: "€ 15,00" },
        { name: "Spicy Vega", desc: "Scharfer Veggie-Burger", price: "€ 15,00", tag: "Veggie" },
      ],
    },
    {
      id: "kinderbox",
    ...
    },
    {
      ...
      items: language === "NL" ? [
        ...
        { name: "Gezond", desc: "Met sla, komkommer, tomaat, paprika, ham, kaas en een eitje", price: "€ 7,50" },
        ...
        { name: "Brie (walnoten en honing)", desc: "Luxe belegd", price: "€ 7,50" },
      ] : language === "EN" ? [
        ...
        { name: "Healthy", desc: "With lettuce, cucumber, tomato, bell pepper, ham, cheese and an egg", price: "€ 7.50" },
        ...
        { name: "Brie (walnuts and honey)", desc: "Luxury topping", price: "€ 7.50" },
      ] : [
        ...
        { name: "Gesund", desc: "Mit Salat, Gurke, Tomate, Paprika, Schinken, Käse und einem Ei", price: "€ 7,50" },
        ...
        { name: "Brie (Walnüsse und Honig)", desc: "Luxuriös belegt", price: "€ 7,50" },
      ],
    },
    {
      id: "broodjes",
  ...
  return (
    <section id="menu" className="relative bg-background py-24 md:py-32 px-4 md:px-8 font-sans">
      <div ref={revealRef} className="reveal max-w-[1400px] mx-auto">
        ...
        {/* Items grid — magazine style, vertical column flow */}
        <div className="columns-1 md:columns-2 gap-x-12">
          {cat.items.map((item, idx) => (
            <div
              key={item.name}
              className="menu-item-hover group flex items-start gap-4 px-4 py-4 rounded-2xl border-b border-ink/8 cursor-default break-inside-avoid"
            >
